...
import { generateCustomPart } from './partSystem.js?v=4.0';
import {
  addAbility,
  ...
  removeAbility,
  upgradeAbility,
} from './specialAbilitySystem.js?v=4.0';
import { logisticsLevel } from './facilitySystem.js?v=4.0';
import { eventChanceMultiplier } from './settingsSystem.js?v=4.0';
