...
import { getSeriesForManufacturer, resolveSeriesProfile } from '../data/seriesDefinitions.js?v=3.7';
import { GROUP_KEYS, RESISTANCE_STATS, STAT_GROUPS } from '../data/statDefinitions.js?v=3.7';
...
import { NEGATIVE_ABILITY_IDS, NORMAL_POSITIVE_ABILITY_IDS, SPECIAL_ABILITIES } from '../data/specialAbilities.js?v=3.7';
