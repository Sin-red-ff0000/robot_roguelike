...
import { WEAPON_KEYS } from '../data/weaponDefinitions.js?v=2.7';
import { MANUFACTURER_MAP } from '../data/manufacturers.js?v=2.7';
import { getSeriesDefinition, resolveSeriesProfile } from '../data/seriesDefinitions.js?v=2.7';
