...
import { STAT_GROUPS } from '../data/statDefinitions.js?v=3.0';
import { TRAINING_TYPES } from '../data/trainingDefinitions.js?v=3.0';
import { WEAPON_CATEGORIES } from '../data/weaponDefinitions.js?v=3.0';
import { clamp, randomFloat, weightedPick } from '../utils/random.js?v=3.0';
