...
import { STAT_GROUPS } from '../data/statDefinitions.js?v=2.9';
import { TRAINING_TYPES } from '../data/trainingDefinitions.js?v=2.9';
import { WEAPON_CATEGORIES } from '../data/weaponDefinitions.js?v=2.9';
import { clamp, randomFloat, weightedPick } from '../utils/random.js?v=2.9';
