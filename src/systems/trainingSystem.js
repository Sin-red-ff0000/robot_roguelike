...
import { STAT_GROUPS } from '../data/statDefinitions.js?v=4.8';
import { TRAINING_TYPES, CONTEXTUAL_TRAINING_VARIANTS } from '../data/trainingDefinitions.js?v=4.8';
import { WEAPON_CATEGORIES } from '../data/weaponDefinitions.js?v=4.8';
import { clamp, randomFloat, weightedPick } from '../utils/random.js?v=4.8';
