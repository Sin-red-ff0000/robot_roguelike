import {SPECIAL_ABILITIES} from '../src/data/specialAbilities.js?v=4.6';
import {V42_EVENT_TEMPLATES} from '../src/data/eventExpansionDefinitions.js?v=4.6';
import {BASE_SYNERGY_RULES} from '../src/data/battleRules.js?v=4.6';
import {SERIES_DEFINITIONS,resolveSeriesProfile} from '../src/data/seriesDefinitions.js?v=4.6';
